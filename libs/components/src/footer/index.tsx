...
const Footer = () => {
  return (
    ...
    <section aria-labelledby="sale-heading">
      <div className="pt-32 overflow-hidden sm:pt-14 bg-neutral-100">
        <div className="bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="relative pt-48 pb-16 sm:pb-24">
              <div>
                <h2 id="sale-heading" className="text-2xl font-bold text-white md:text-4xl">
                  DOWNLOAD
                  <br />
                  MOBILE APPLICATION
                </h2>
                <div className="mt-6 text-base flex gap-4">
                  <a href="#" className="text-white">
                    <IconBrandGooglePlay size={40} color="#ff3434" />
                    </a>
                  <a href="#" className=" text-white">
                    <IconBrandAppstore size={40} color="#5495ff" />
                    </a>
                </div>
              </div>
