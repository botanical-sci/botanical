...
const Checkout: FC<Props> = () => {
  ...
  return (
    <main className="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:px-6 lg:max-w-[1432px] lg:px-8">
      ...
      <div className="block lg:grid xl:grid grid-cols-12 gap-9">
        {/* Checkout form */}
        <section aria-labelledby="payment-heading" className="col-span-6">
        ...
        >
          ...
          <div className="bottom-0 flex-none bg-gray-50 border-t border-gray-200 p-6">
            ...
            <dl className="text-sm font-medium text-gray-500 mt-10 space-y-6">
              <div className="flex justify-between">
                <dt>Subtotal</dt>
                <dd className="text-gray-900">${cartStore.subtotal()}</dd>
              </div>
              {/* <div className="flex justify-between">
                <dt className="flex">
                  Discount
              ...
              <div className="flex justify-between">
                <dt>Taxes</dt>
                <dd className="text-gray-900">$1.49</dd>
              </div>
              <div className="flex justify-between">
                <dt>Shipping</dt>
              ...
              <div className="flex items-center justify-between border-t border-gray-200 text-gray-900 pt-6">
                <dt>Total</dt>
                <dd className="text-base">${cartStore.subtotal()}</dd>
              </div>
            </dl>
          </div>
        </section>
